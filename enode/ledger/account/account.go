...
* @Description: 仿照比特币钱包策略实现账户模块，基本思路一致。
***********************************************************************/
...
// 验证账户地址是否是合法的
func ValidateAccount(address string) bool {
	//由字符串账户地址解码得到所谓的公钥哈希（加入了校验码和版本号的）
